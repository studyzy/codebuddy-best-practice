...
> 来源: https://www.codebuddy.cn/docs/cli/sdk-mcp


# SDK MCP Integration Guide ​

> 版本要求：本文档针对 CodeBuddy Agent SDK v0.1.24 及以上版本。功能状态：SDK MCP 支持是 CodeBuddy Agent SDK 的一项 Preview 功能。
...
1. 文件路径字符串：指向一个 MCP 配置文件（JSON 格式）
