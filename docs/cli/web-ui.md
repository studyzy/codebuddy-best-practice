...
> 来源: https://www.codebuddy.cn/docs/cli/web-ui
...
终端会显示二维码和 URL。用手机扫码或在浏览器中打开 URL。详见远程控制文档。
...
- 远程控制 — 通过 Gateway 和 Tunnel 启动 Web UI
- HTTP API — 完整的 REST API 文档
- ACP 协议 — IDE 集成的 Agent Client Protocol
- 设置 — 配置选项
