...
> 来源: https://www.codebuddy.cn/docs/cli/skills
...
1. 用户级 Skills：~/.codebuddy/skills/（用户主目录下）
...
1. 工具需求：任务所需工具是否在 allowed-tools 范围内
1. 上下文相关性：当前对话上下文是否适合使用该 Skill
1. Skill 来源：项目级 Skills 优先于用户级 Skills
