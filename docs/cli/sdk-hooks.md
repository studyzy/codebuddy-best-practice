...
> 来源: https://www.codebuddy.cn/docs/cli/sdk-hooks
...
- createdAt: 创建时间戳
- fileSnapshots: 文件路径到版本信息的映射 filePath: 文件绝对路径version: 版本号backupFileName: 备份文件名backupTime: 备份时间戳
- fileChangeStats: 文件变更统计 files: 变更的文件路径列表additions: 新增行数deletions: 删除行数
