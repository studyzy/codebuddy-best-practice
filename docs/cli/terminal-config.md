...
> 来源: https://www.codebuddy.cn/docs/cli/terminal-config
...
如需进一步自定义 CodeBuddy Code 界面本身，您可以配置自定义状态行在终端底部显示上下文信息，如当前模型、工作目录或 git 分支等。
...
1. 打开 设置 → 描述文件 → 键盘
1. 勾选"将 Option 用作 Meta 键"

对于 iTerm2 和 VS Code 终端：

1. 打开 Settings → Profiles → Keys
1. 在"General"下，将 Left/Right Option 键设置为"Esc+"
...
1. 打开 iTerm 2 偏好设置
1. 导航到 Profiles → Terminal
1. 启用"Silence bell"和 Filter Alerts → “Send escape sequence-generated alerts”
1. 设置您偏好的通知延迟
