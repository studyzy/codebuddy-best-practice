#!/usr/bin/env python3
"""
CodeBuddy Code Hook Handler
=============================================
This script handles events from CodeBuddy Code and plays sounds for different hook events.
Supports all CodeBuddy Code hooks
...
def play_sound(sound_name):
    ...
    Args:
        sound_name: Name of the sound file (e.g., "pretooluse", "pretooluse-git-committing")
                   The file should be at .codebuddy/hooks/sounds/{folder}/{sound_name}.{mp3|wav}
    ...
    # Scripts are in .codebuddy/hooks/scripts/, sounds are in .codebuddy/hooks/sounds/
    script_dir = Path(__file__).parent  # .codebuddy/hooks/scripts/
    hooks_dir = script_dir.parent  # .codebuddy/hooks/
...
def is_hook_disabled(event_name):
    ...
    """
    try:
        # Scripts are in .codebuddy/hooks/scripts/, config is in .codebuddy/hooks/config/
        script_dir = Path(__file__).parent  # .codebuddy/hooks/scripts/
        hooks_dir = script_dir.parent  # .codebuddy/hooks/
        config_dir = hooks_dir / "config"  # .codebuddy/hooks/config/
...
def log_hook_data(hook_data, agent_name=None):
    ...
    Log file is stored at .codebuddy/hooks/logs/hooks-log.jsonl
    ...
    try:
        # Scripts are in .codebuddy/hooks/scripts/, logs are in .codebuddy/hooks/logs/
        script_dir = Path(__file__).parent  # .codebuddy/hooks/scripts/
        hooks_dir = script_dir.parent  # .codebuddy/hooks/
        logs_dir = hooks_dir / "logs"  # .codebuddy/hooks/logs/
