...
> 来源: https://www.codebuddy.cn/docs/cli/sdk-custom-tools


# SDK Custom Tools Guide ​

> 版本要求：本文档针对 CodeBuddy Agent SDK v0.1.24 及以上版本。功能状态：SDK Custom Tools 是 CodeBuddy Agent SDK 的一项 Preview 功能。
