...
> 来源: https://www.codebuddy.cn/docs/cli/statusline
...
- 通过使用模拟 JSON 输入手动运行脚本来测试您的脚本：bashecho '{"model":{"display_name":"测试"},"workspace":{"current_dir":"/test"}}' | ./statusline.sh
