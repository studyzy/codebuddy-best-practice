...
> 来源: https://www.codebuddy.cn/docs/cli/acp
...
- env：可选的环境变量配置，例如：json{
  "env": {
    "CODEBUDDY_API_KEY": "your-api-key",
    "CODEBUDDY_INTERNET_ENVIRONMENT": "internal"
  }
}注意：使用 CODEBUDDY_API_KEY 时，必须根据版本正确配置 CODEBUDDY_INTERNET_ENVIRONMENT：海外版：不设置（默认）中国版：internaliOA 版：ioa详见 身份和访问管理文档。
...
1. 确认 codebuddy 命令可用：bashwhich codebuddy
1. 测试 ACP 模式启动：bashcodebuddy --acp
