...
> 来源: https://www.codebuddy.cn/docs/cli/sdk-demos
...
1. API Key 认证：通过环境变量配置

详细的认证配置请参阅 设置配置 - 认证相关
...
1. 研究员 使用 WebSearch 搜索信息，保存到 files/research_notes/
1. 数据分析师 从研究笔记提取数据，生成图表到 files/charts/
1. 报告撰写者 整合内容，生成 PDF 报告到 files/reports/
...
- SDK 概览 - SDK 完整介绍
- TypeScript SDK 参考 - TypeScript API 详细文档
- Python SDK 参考 - Python API 详细文档
- MCP 集成 - MCP 服务器配置
- 子 Agent 系统 - 多 Agent 协作详解
